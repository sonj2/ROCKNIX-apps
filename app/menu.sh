...
RUN=(
  ...
  [2]="echo 'VacuumTube (YouTube TV UI)...'; curl -L https://github.com/sonj2/ROCKNIX-apps/raw/main/vacuumtube.sh | bash"
  #[5]="echo 'Greenlight...'; curl -L https://github.com/sonj2/ROCKNIX-apps/raw/main/greenlight.sh | bash"
  [3]="echo 'Chiaki (PS4/PS5)...'; curl -L https://github.com/sonj2/ROCKNIX-apps/raw/main/chiaki/chiaki.sh | bash"
  [4]="echo 'Firefox...'; curl -L https://github.com/sonj2/ROCKNIX-apps/raw/main/firefox.sh | bash"
  #[8]="echo 'Brave (AppImage)...'; curl -L https://github.com/sonj2/ROCKNIX-apps/raw/main/brave/brave.sh | bash"
  [5]="echo 'Ungoogled-Chromium (AppImage)...'; curl -L https://github.com/sonj2/ROCKNIX-apps/raw/main/ugc.sh | bash"
  [6]="echo 'LibreWolf + Leanback...'; curl -L https://github.com/sonj2/ROCKNIX-apps/raw/main/librewolf/librewolf.sh | bash"
  #[8]="echo 'Chromium (RunImage)...'; curl -L https://github.com/sonj2/ROCKNIX-apps/raw/main/chromium/arch-chromium.sh | bash"
  #[8]="echo 'Kodi (RunImage)...'; curl -L https://github.com/sonj2/ROCKNIX-apps/raw/main/kodi/arch-kodi.sh | bash"
  ...
  [7]="echo 'Free Homebrew ROM Pack...'; curl -L https://github.com/sonj2/ROCKNIX-apps/raw/main/freebatroms.sh | bash"
  #[16]="echo 'Flatpak wrapper (RunImage)...'; curl -L https://github.com/sonj2/ROCKNIX-apps/raw/main/flatpak/flatpak.sh | bash"
  [8]="echo 'Soar (pkg-forge)...'; curl -L https://github.com/sonj2/ROCKNIX-apps/raw/main/soar.sh | bash"
  [9]="echo 'PKGX (CLI tool mgr)...'; curl -L https://github.com/sonj2/ROCKNIX-apps/raw/main/pkgx/pkgx.sh | bash"
  #[13]="echo 'ROCKNIX-WINE Setup tool...'; curl -L https://github.com/sonj2/Rocknix-WINE/raw/main/wine_setup.sh | bash"
  [10]="echo 'JeodC Pharos App (External Portmaster apps)'; curl -L https://github.com/sonj2/ROCKNIX-apps/raw/main/pharos.sh | bash"
  [11]="echo 'BatleXP G350 Audio Fix'; curl -L https://github.com/sonj2/ROCKNIX-apps/raw/main/batlexpg350/install_speaker_fix.sh | bash"
  [12]="echo 'pip & piptools'; curl -L https://github.com/sonj2/ROCKNIX-apps/raw/main/piptools.sh | bash"
  [13]="echo 'FreeTube'; curl -L https://github.com/sonj2/ROCKNIX-apps/raw/main/freetube.sh | bash"
...
OPTIONS=(
  ...
  "2"  "VacuumTube (YouTube TV UI)"
  #"5"  "Greenlight (Xbox/Xcloud)"
  "3"  "Chiaki (PS4/PS5 Remote Play)"
  "4"  "Firefox"
  #"8"  "Brave (AppImage)"
  "5"  "Ungoogled-Chromium (AppImage)"
  "6" "LibreWolf + Leanback TV Profile"
  #"8" "Chromium (RunImage)"
  #"8" "Kodi (RunImage)"
  #"13" "ES Carbon Theme"
  #"14" "ES Music Pack"
  "7" "Free Homebrew ROM Pack"
  #"16" "Flatpak wrapper (RunImage)"
  "8" "Soar (pkg-forge)"
  "9" "PKGX (CLI tool mgr)"
  #"13" "Wine Setup Tool"
  "10" "JeodC Pharos App (External Portmaster repositories)"
  "11" "BatleXP G350 Audio fix"
  "12" "PIP tools"
  "13" "FreeTube"
  "99" "Exit"
)
