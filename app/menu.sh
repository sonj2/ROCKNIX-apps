...
RUN=(
  ...
  [3]="echo 'Caja + Engrampa...'; curl -L https://github.com/sonj2/ROCKNIX-apps/raw/main/caja/caja-build.sh | bash"
  ...
  [11]="echo 'Chromium (RunImage)...'; curl -L https://github.com/sonj2/ROCKNIX-apps/raw/main/chromium/arch-chromium.sh | bash"
  [12]="echo 'Kodi (RunImage)...'; curl -L https://github.com/sonj2/ROCKNIX-apps/raw/main/kodi/arch-kodi.sh | bash"
