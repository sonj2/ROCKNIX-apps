...
RUN=(
  ...
  [9]="echo 'Free Homebrew ROM Pack...'; curl -L https://github.com/sonj2/ROCKNIX-apps/raw/main/freebatroms.sh | bash"
  #[16]="echo 'Flatpak wrapper (RunImage)...'; curl -L https://github.com/sonj2/ROCKNIX-apps/raw/main/flatpak/flatpak.sh | bash"
  [10]="echo 'Soar (pkg-forge)...'; curl -L https://github.com/sonj2/ROCKNIX-apps/raw/main/soar.sh | bash"
  [11]="echo 'PKGX (CLI tool mgr)...'; curl -L https://github.com/sonj2/ROCKNIX-apps/raw/main/pkgx/pkgx.sh | bash"
  #[13]="echo 'ROCKNIX-WINE Setup tool...'; curl -L https://github.com/sonj2/Rocknix-WINE/raw/main/wine_setup.sh | bash"
  [12]="echo 'JeodC Pharos App (External Portmaster apps)'; curl -L https://github.com/sonj2/ROCKNIX-apps/raw/main/pharos.sh | bash"
  [13]="echo 'BatleXP G350 Audio Fix'; curl -L https://github.com/sonj2/ROCKNIX-apps/raw/main/batlexpg350/install_speaker_fix.sh | bash"
  [14]="echo 'pip & piptools'; curl -L https://github.com/sonj2/ROCKNIX-apps/raw/main/piptools.sh | bash"
  [15]="echo 'FreeTube'; curl -L https://github.com/sonj2/ROCKNIX-apps/raw/main/freetube.sh | bash"
...
OPTIONS=(
  ...
  #"13" "ES Carbon Theme"
  #"14" "ES Music Pack"
  "9" "Free Homebrew ROM Pack"
  #"16" "Flatpak wrapper (RunImage)"
  "10" "Soar (pkg-forge)"
  "11" "PKGX (CLI tool mgr)"
  #"13" "Wine Setup Tool"
  "12" "JeodC Pharos App (External Portmaster repositories)"
  "13" "BatleXP G350 Audio fix"
  "14" "PIP tools"
  "15" "FreeTube"
  "99" "Exit"
)
